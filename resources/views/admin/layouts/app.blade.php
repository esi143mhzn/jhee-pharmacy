...
<head>
    ...
    <title>Jhee-Pharmacy - Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin.dashboard.index')}}">
                ...
                <div class="sidebar-brand-text mx-3">Jhee Pharmacy <sup>2</sup></div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>&copy; 2022 Jhee-Pharmacy. All rights reserved | Design by <a href="https://www.fb.com/esi143mhzn" style="text-decoration: none;" target="_blank"> Promise Maharjan.</a></span> 
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
