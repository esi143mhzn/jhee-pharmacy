            ...
            <div class="item active">
                <div class="container">
                    <div class="carousel-caption">
                        ...
                        <a class="button2" href="{{ url('/kitchen/product') }}">Shop Now </a>
                    </div>
                </div>
            </div>
                ...
                <div class="deal-leftmk left-side">
                    ...
                    <div class="special-sec1">
                        ...
                        <div class="col-xs-8 img-deal1">
                            ...
                            <a href="{{ url('/kitchen/single-product') }}">$18.00</a>
                        </div>
                    ...
                    <div class="special-sec1">
                        ...
                        <div class="col-xs-8 img-deal1">
                            ...
                            <a href="{{ url('/kitchen/single-product') }}">$9.00</a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="special-sec1">
                        ...
                        <div class="col-xs-8 img-deal1">
                            <h3>Tata Salt</h3>
                            <a href="{{ url('/kitchen/single-product') }}">$15.00</a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="special-sec1">
                        ...
                        <div class="col-xs-8 img-deal1">
                            ...
                            <a href="{{ url('/kitchen/single-product') }}">$525.00</a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="special-sec1">
                        ...
                        <div class="col-xs-8 img-deal1">
                            ...
                            <a href="{{ url('/kitchen/single-product') }}">$149.00</a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
                ...
                <div class="wrapper">
                    ...
                    <div class="product-sec1">
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('assets/images/mk4.jp') }}g" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="{{ url('/kitchen/single-product') }}" class="link-product-add-cart">Quick View</a>
                                        </div>
                                ...
                                <div class="item-info-product ">
                                    <h4>
                                        <a href="{{ url('/kitchen/single-product') }}">Freedom Oil, 1L</a>
                                    </h4>
                                    <div class="info-product-price">
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('assets/images/mk5.jp') }}g" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="{{ url('/kitchen/single-product') }}" class="link-product-add-cart">Quick View</a>
                                        </div>
                                ...
                                <div class="item-info-product ">
                                    <h4>
                                        <a href="{{ url('/kitchen/single-product') }}">Saffola Gold, 1L</a>
                                    </h4>
                                    <div class="info-product-price">
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('assets/images/mk6.jp') }}g" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="{{ url('/kitchen/single-product') }}" class="link-product-add-cart">Quick View</a>
                                        </div>
                                ...
                                <div class="item-info-product ">
                                    <h4>
                                        <a href="{{ url('/kitchen/single-product') }}">Fortune Oil, 5L</a>
                                    </h4>
                                    <div class="info-product-price">
                    ...
                    <div class="product-sec1">
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('assets/images/mk7.jp') }}g" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="{{ url('/kitchen/single-product') }}" class="link-product-add-cart">Quick View</a>
                                        </div>
                                ...
                                <div class="item-info-product ">
                                    <h4>
                                        <a href="{{ url('/kitchen/single-product') }}">Yippee Noodles, 65g</a>
                                    </h4>
                                    <div class="info-product-price">
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('assets/images/mk8.jp') }}g" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="{{ url('/kitchen/single-product') }}" class="link-product-add-cart">Quick View</a>
                                        </div>
                                ...
                                <div class="item-info-product ">
                                    <h4>
                                        <a href="{{ url('/kitchen/single-product') }}">Wheat Pasta, 500g</a>
                                    </h4>
                                    <div class="info-product-price">
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('assets/images/mk9.jp') }}g" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="{{ url('/kitchen/single-product') }}" class="link-product-add-cart">Quick View</a>
                                        </div>
                                ...
                                <div class="item-info-product ">
                                    <h4>
                                        <a href="{{ url('/kitchen/single-product') }}">Chinese Noodles, 68g</a>
                                    </h4>
                                    <div class="info-product-price">
