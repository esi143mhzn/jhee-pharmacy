					...
					<div class="product-sec1">
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('kitchen/single-product') }}">Zeeba Basmati Rice</a>
									</h4>
						...
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('kitchen/single-product') }}">Maiyas Gulab Jamun</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('kitchen/single-product') }}">Lipton Green Tea</a>
									</h4>
									<div class="info-product-price">
					...
					<div class="product-sec1">
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('kitchen/single-product') }}">Organicana Red Chilli</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('kitchen/single-product') }}">MTR Black Pepper</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('kitchen/single-product') }}">Chataka - Elaichi</a>
									</h4>
									<div class="info-product-price">
					...
					<div class="product-sec1">
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('kitchen/single-product') }}">Narulag, Less Sugar</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('kitchen/single-product') }}">Kellogg's Chocos Fills</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('kitchen/single-product') }}">Amul's India</a>
									</h4>
									<div class="info-product-price">
					...
					<div class="product-sec1">
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('kitchen/single-product') }}">Snickers Chocolates</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('kitchen/single-product') }}">Kissan Fruit Jam</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('kitchen/single-product') }}">MTR Vegetable Pickle</a>
									</h4>
									<div class="info-product-price">
