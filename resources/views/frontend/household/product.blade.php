					...
					<div class="product-sec1">
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									...
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="{{ url('household/single-product')}}" class="link-product-add-cart">Quick View</a>
										</div>
									</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('household/single-product')}}">Vim Dishwash Gel</a>
									</h4>
						...
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('household/single-product')}}">Harpic Cleaner</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('household/single-product')}}">Comfort After Wash</a>
									</h4>
									<div class="info-product-price">
					...
					<div class="product-sec1">
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('household/single-product')}}">Odonil Blocks (3+1)</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('household/single-product')}}">Surf Excel Detergent</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('household/single-product')}}">Sunsilk Shampoo</a>
									</h4>
									<div class="info-product-price">
					...
					<div class="product-sec1">
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('household/single-product')}}">Gala Leader Floor Mop</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('household/single-product')}}">Spotzero Spin Mop</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('household/single-product')}}">Spotzero Zero Dust</a>
									</h4>
									<div class="info-product-price">
					...
					<div class="product-sec1">
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('household/single-product')}}">All Out 480 Hours</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('household/single-product')}}">Wall Hanging</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="{{ url('household/single-product')}}">Colin Regular Refill</a>
									</h4>
									<div class="info-product-price">
			...
			<div class="content-bottom-in">
				<ul id="flexiselDemo1">
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="{{ url('household/single-product')}}">
									<img src="images/s3.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
									<a href="{{ url('household/single-product')}}">Surf Excel Liquid, 1.02L</a>
								</h4>
								<div class="w3l-pricehkj">
									<h6>$187.00</h6>
									<p>Save $30.00</p>
					...
					<li>
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								<h4>
									<a href="{{ url('household/single-product')}}">Fair & Lovely, 80 g</a>
								</h4>
								<div class="w3l-pricehkj">
									<h6>$121.60</h6>
									<p>Save $30.00</p>
					...
					<li>
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								<h4>
									<a href="{{ url('household/single-product')}}">Lakme Eyeconic Kajal, 0.35 g</a>
								</h4>
								<div class="w3l-pricehkj">
									<h6>$153.00</h6>
									<p>Save $40.00</p>
