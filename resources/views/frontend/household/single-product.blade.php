			...
			<div class="col-md-5 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="{{ asset('assets/images/se1.jpg') }}">
								<div class="thumb-image">
									<img src="{{ asset('assets/images/se1.jpg') }}" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="{{ asset('assets/images/se2.jpg') }}">
								<div class="thumb-image">
									<img src="{{ asset('assets/images/se2.jpg') }}" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="{{ asset('assets/images/se3.jpg') }}">
								<div class="thumb-image">
									<img src="{{ asset('assets/images/se3.jpg') }}" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
						</ul>
			...
			<div class="content-bottom-in">
				<ul id="flexiselDemo1">
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="{{('household/single-product')}}">
									<img src="{{ asset('assets/images/s3.jpg"') }} alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
									<a href="{{('household/single-product')}}">Surf Excel Liquid, 1.02L</a>
								</h4>
								<div class="w3l-pricehkj">
									<h6>$187.00</h6>
									<p>Save $30.00</p>
					...
					<li>
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								<h4>
									<a href="{{('household/single-product')}}">Fair & Lovely, 80 g</a>
								</h4>
								<div class="w3l-pricehkj">
									<h6>$121.60</h6>
									<p>Save $30.00</p>
					...
					<li>
						<div class="w3l-specilamk">
							...
							<div class="product-name-w3l">
								<h4>
									<a href="{{('household/single-product')}}">Lakme Eyeconic Kajal, 0.35 g</a>
								</h4>
								<div class="w3l-pricehkj">
									<h6>$153.00</h6>
									<p>Save $40.00</p>
